...
# Create folders for portals
os.makedirs('frontend/src/portals/Customer', exist_ok=True)
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/approvals" element={<ProtectedRoute allowedRole="ADMIN"><Approvals /></ProtectedRoute>} />
          <Route path="/admin/outbox" element={<ProtectedRoute allowedRole="ADMIN"><OutboxMonitor /></ProtectedRoute>} />
          <Route path="/admin/audit" element={<ProtectedRoute allowedRole="ADMIN"><AuditLog /></ProtectedRoute>} />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
  );
...
print("Created folder structure and App.jsx routing.")
