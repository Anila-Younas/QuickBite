...
async function createTestOrderForDecline() {
  let conn;
  try {
    ...
    const result = await conn.execute(
      ...
      [
        ...
        5, // Rider Hamza
        600, // Total
        'Test Address for Decline, Mianwali', // Address
    ...
    console.log('✅ Test order created for decline testing! Order ID:', newOrderId);
